...
document.addEventListener('DOMContentLoaded', function () {
  ...
  document.querySelector('.sidebar__btn-wrap--mob').addEventListener('click', function () {
    document.querySelector('.sidebar--mob').classList.toggle('sidebar--mob--active'); // document.querySelector('.sidebar-wrap--mob').classList.toggle('sidebar-wrap--mob--active')
